...
<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del">删除</a>
  ...
  <div class="layui-btn-container">
	...
	<script>
	var execoperator_id ="${param.execoperator_id}";
		layui.use('table', function() {
			...
			table.render({
				elem : '#demo',
				height : 462,
				url : '../Myrevisit.action' //数据接口
				,
				where:{execoperator_id:execoperator_id},
				toolbar : '#toolbarDemo',
				page : true //开启分页
				,
				cols : [ [ //表头
			...
			table.on('tool(test)', function(obj) {
				...
				if (obj.event === 'del') { ///lay-event 属性
					...
					openFrame('../../Revisit/edit.jsp?id='+data.id,'编辑',['800px', '70%']);
				}
			});
