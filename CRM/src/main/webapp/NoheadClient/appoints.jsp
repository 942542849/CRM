...
<form class="layui-form" lay-filter="myform" action="updates.action">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      	<input type="hidden" name="operatorids" class="layui-input">
		<input type="text" name="operatornames"  autocomplete="off" placeholder="请选择处理人" class="layui-input" id="demo"> 
    </div>
