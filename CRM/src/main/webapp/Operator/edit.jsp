...
<input type="hidden" name="id" >
  <div class="layui-form-item">
   ...
   <div class="layui-form-item">
    <label class="layui-form-label">用户属组</label>
    <div class="layui-input-block">
...
$.post("edit.action",{id:id}, function(json) {
	...
	getlist("getGroups.action",{},"[name=group_id]",json.group_id);
	getarray("getPowers.action",{},"[name=power]",json.power);
	getarray("getStatuss.action",{},"[name=status]",json.status);
},"json");
